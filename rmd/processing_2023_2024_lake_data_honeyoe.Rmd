---
title: "macroinvertebrate_processing_lakes"
author: 'NYSDEC SMAS : Keleigh Reynolds'
date: "10/14/2025"
output: html_document
params:
  file_name: "L:/DOW/BWAM Share/data/lab_data/WAA/2024/raw/MacroTaxa_Lakes2023_&_Honeoye2024.csv"
  user: kareynol
  file_type: "waa"
---
...
#add group
honey<-raw |> 
  filter(MSSIH_EVENT_SMAS_HISTORY_ID %in% "04-LHONYE-0.0")

raw<-raw |> 
  mutate(group = case_when(
    MSSIH_EVENT_SMAS_HISTORY_ID %in% "04-LHONYE-0.0" &
      MSSIH_EVENT_SMAS_SAMPLE_DATE %in% "06/04/2024" ~ "A",
    MSSIH_EVENT_SMAS_HISTORY_ID %in% "04-LHONYE-0.0" &
      MSSIH_EVENT_SMAS_SAMPLE_DATE %in% "06/05/2024" ~ "B",
    TRUE~""))
...
#write this to file for matt
write.csv(bap.prepped,here::here("outputs/c2023_2024honeoye_10_23_25.csv"))
...
sample_final_2<-sample_final_2 %>% 
  distinct()
#create check
final_metrics_3<-final_metrics_ %>% 
  distinct()
